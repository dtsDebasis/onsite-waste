                            ...
                            @if(count($inventories))
                                @foreach($inventories as $ikey => $ival)
                                    <tr class="">
                                        ...
                                        <td>{!! Form::select('sh_container_type',['Spinner'=>'Spinner','Rocker'=>'Rocker'],$ival->sh_container_type,['class'=>'form-control select2','id'=>'sh_container_type','placeholder'=>'Choose ...']) !!}</td>
                                        ...
                                        <td>{!! Form::select('rb_container_type',['Rocker'=>'Rocker','Open'=>'Open'],$ival->rb_container_type,['class'=>'form-control select2','id'=>'rb_container_type','placeholder'=>'Choose ...']) !!}</td>
