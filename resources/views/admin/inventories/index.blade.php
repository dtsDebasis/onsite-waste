                        ...
                        <table class="table table-centered table-nowrap mb-0" id="inventories_table">
                            ...
                            @if(count($inventories))
                                @foreach($inventories as $ikey => $ival) 
                                    <tr class="">
                                        <td>{{$ival->name}}</td>
                                        @php($inventory_details = $ival->inventory_details['canisterInventory'])
                                        ...
                                        <td>{!! Form::select('sh_container_type',['Spinner'=>'Spinner','Rocker'=>'Rocker'],$inventory_details[1]['canisterType'],['class'=>'form-control select2','id'=>'sh_container_type','placeholder'=>'Choose ...']) !!}</td>
                                        ...
                                        <td>{!! Form::select('rb_container_type',['Rocker'=>'Rocker','Open'=>'Open'],$inventory_details[0]['canisterType'],['class'=>'form-control select2','id'=>'rb_container_type','placeholder'=>'Choose ...']) !!}</td>
                                        <td>
