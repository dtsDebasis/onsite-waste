...
<div class="card-body card mb-4">
    <div class="d-flex flex-column flex-md-row justify-content-between">
        ...
        <a href="{{route('location.countries.states.create',$routeParams)}}" class="btn btn-primary w-md">Add New</a>
    </div>
                    ...
                    @if(count($data) != 0)
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                          ...
                          <a href="{{ route($routePrefix . '.cities.index', $routeParams) }}" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" data-toggle="tooltip" title="" data-original-title="View Cities"><i class="bx bx-list-ul"></i></a>
                          @endif
                          @if($permission['edit'])
