...
<div class="card-body card mb-4">
    <div class="d-flex flex-column flex-md-row justify-content-between">
        @if (can('Banner Search'))
        <form class="form-inline checkeditingall_package_details" method="get" action="{{route('banners.index')}}">
        ...
        @endif
        @if (can('Banner Add'))
        <a href="{{route('banners.create')}}" class="btn btn-primary w-md">Add New</a>
        @endif
    </div>
                ...
                <table class="table table-centered table-nowrap mb-0">
                    <thead class="thead-light">
                        <tr>
                            ...
                            @if(can('Banner Edit') || can('Banner Delete'))
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img style="max-height:25px" src="{{$val->banner['thumb']}}" alt=""></td>
                            <td>{{ $val->title }}</td>
                            <td><span
