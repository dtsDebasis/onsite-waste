        ...
        @endif
            ...
            <div class="col-md-3">
                ...
                {!! Form::label('name', 'Package Name <span class="span-req">*</span>:',array('class'=>'','for'=>'name'),false) !!}
                            {!! Form::select('name',$packagenames->pluck('name','name'),null,['packagenames'=>$packagenames,'class'=>'form-control select2','placeholder'=>'Choose ...','id'=>'choose_branch_package','required'=>'required']) !!}
                    @if ($errors->has('name'))
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('service_type',$packagenames->pluck('service_type','service_type'),null,['class'=>'form-control select2','placeholder'=>'Choose ...','id'=>'service_type','required'=>'required','readonly'=>$package ? true : false]) !!}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::number('monthly_rate',null,['class'=>'form-control','placeholder'=>'Enter amount','id'=>'monthly_rate','required'=>'required','step'=>'0.01','readonly'=>$package ? true : false]) !!}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {!! Form::select('compliance',$yes_no_arr,null,['class'=>'form-control select2','placeholder'=>'Choose ...','id'=>'compliance','required'=>'required','readonly'=>$package ? true : false]) !!}
            ...
            <div class="col-md-5 service-based-view {{$service_dnone}}">
                <div class="form-group">
                    ...
                    <div class="col-md-12 row">
                        {!! Form::number('frequency_number',null,['class'=>'form-control col-md-7','placeholder'=>'Enter number','id'=>'frequency_number','required'=>'required','step'=>'0.01','readonly'=>$package ? true : false]) !!}
                        @if ($errors->has('frequency_number'))
                            <span class="help-block">{{ $errors->first('frequency_number') }}</span>
                        @endif
                        <div class="col-md-5">
                            {!! Form::select('frequency_type',$frequency_types,null,['class'=>'form-control select2','placeholder'=>'Choose ...','id'=>'frequency_type','required'=>'required','readonly'=>$package ? true : false]) !!}
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 service-based-view {{$service_dnone}}">
                <div class="form-group">
                    ...
                    {!! Form::number('boxes_included',null,['class'=>'form-control','placeholder'=>'Enter number','id'=>'boxes_included','required'=>'required','step'=>'0','readonly'=>$package ? true : false]) !!}
