        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    ...
                    <div class="col-md-4">
                        <a href="{{route('customers.create', ['id'=> 0 ] )}}" type="submit" class="btn btn-primary w-md">Add Customer</a>
                            ...
                            <table class="table table-centered table-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td> <a href="{{ route('customers.branches', ['id' => $company->id  ] ) }}">{{$company->company_name ?? '' }}</a></td>
                                        <td>{{($company->created_at)?\App\Helpers\Helper::showdate($company->created_at):'NA'}}</td>
                                        ...
                                        <td>NA</td>
                                        <td>
                                            <a class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" href="{{ route('customers.create', ['id' => $company->id  ] ) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="bx bx-edit-alt"></i></a>
                                            <a class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" href="{{ route('customers.branches', ['id' => $company->id  ] ) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Branch Lists" ><i class="fa fa-building"></i></a>
                                            <a class="btn btn-outline-danger waves-effect" data-toggle="tooltip" title="" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="event.preventDefault();
                                                document.getElementById('delete-form-{{$company->id}}').submit();" data-original-title="Delete">{!! \Config::get('settings.icon_delete') !!}</a>
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => [
                                                    'customers.destroy',
...
<div class="modal fade import_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'POST','route' => ['customers.import-data'],'id' => 'import-form','enctype' => 'multipart/form-data']) !!}
