...
<div class="table-responsive">
  <table class="table table-condensed">
    <thead>
      <tr>
        <th>Question {!! \App\Helpers\Helper::sort($routePrefix . '.index', 'question', $orderBy) !!}</th>
        <th>Type </th>
        <th>Display Order {!! \App\Helpers\Helper::sort($routePrefix . '.index', 'display_order', $orderBy) !!}</th>
        <th>Field Type {!! \App\Helpers\Helper::sort($routePrefix . '.index', 'field_type', $orderBy) !!}</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{!! $val->fieldTypes[$val->field_type] !!}</td>
