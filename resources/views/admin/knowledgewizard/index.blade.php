...
<div class="card-body card mb-4">
    ...
    @if (can('Knowledge Wizard Search'))
         <form class="form-inline checkediting" method="get" action="{{route('knowledgewizard.index')}}">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-centered table-nowrap mb-0">
                    ...
                    <tr>
                      ...
                      @if(can('Knowledge Wizard Edit') || can('Knowledge Wizard Delete'))
                    ...
                    @if(count($data) != 0)
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                          ...
                          @endif
                          @if(can('Knowledge Wizard Delete'))
