...
class LoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // Customization: If client type not admin return failed_status error.
        if ($client->user_type != 'admin') {
            return $this->sendFailedLoginResponse($request, 'Permission access denied. Please conract administrator.');
        }
