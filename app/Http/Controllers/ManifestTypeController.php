...
class ManifestTypeController extends Controller
{
    public function __construct($parameters = array())
    {
        parent::__construct($parameters);
        
        $this->_module      = 'Manifest Type';
        $this->_routePrefix = 'master.manifesttypes';
        $this->_model       = new ManifestType();
        $this->_offset = 15;
    }
    ...
    public function index(Request $request)
    {
        ...
        $this->_data['lead_source']         = $this->_model->leadtype;
        ...
        $form = [
            ...
            'fields'     => [
                ...
                'type'            => [
                    ...
                    'type'          => 'select',
                    'label'         => 'Type',
                    'options'       => ['1'=>'Parent','2'=>'SubType'],
                    'value'         => isset($data->type) ? $data->type : 1,
                ],
